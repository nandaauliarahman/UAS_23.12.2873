            ...
            <div
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div>
                        ...
                        <h2 class="text-5xl font-black">{{ $event->price > 0 ? 'Rp ' . number_format($event->price, 0, ',', '.') : 'Gratis' }}
                            <span class="text-lg font-medium text-indigo-200">/ orang</span></h2>
                        <p class="mt-4 text-indigo-100 flex items-center gap-2">
                            ...
                            @else
                                <span class="font-bold underline">Tiket Habis</span>
                            @endif
                        </p>
                    </div>
                    <div>
                        ...
                        @else
                        <span class="inline-block px-10 py-5 bg-white/50 text-indigo-100 rounded-2xl font-black text-xl cursor-not-allowed">
                            Tiket Habis
                        </span>
                        @endif
                    </div>
